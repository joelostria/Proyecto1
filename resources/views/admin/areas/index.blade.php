...
s1.async=true;
s1.src='https://embed.tawk.to/5be3a7710e6b3311cb785c2f/1crokq5c0';
s1.charset='UTF-8';
...
<!-- Content Header (Page header) -->
    ...
    <section class="content">
		...
		<table class="table table-striped" >
		    ...
		    <tbody>
		      ...
		      <tr ng-repeat="area in areas | filter:search:startsWith">
		        ...
		        <td><a ng-click="selectArea(area)" data-toggle="modal" data-target="#myModalViewPDF" href="@{{area.informacion_general}}" class="btn btn-default"><span class="fa fa-file-pdf-o"></span></a> &nbsp;<a ng-click="selectArea(area)" data-toggle="modal" data-target="#myModalViewVid" href="@{{area.video_general}}" class="btn btn-default"><span class="fa fa-film"></span></a> &nbsp;<a ng-click="selectArea(area)" data-toggle="modal" data-target="#myModalViewIMG" href="@{{area.imagen_general}}" class="btn btn-default"><span class="fa fa-file-image-o"></span></a></td>
      ...
      <div class="modal fade" id="myModalViewPDF" role="dialog">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
               <button type="button" class="close" data-dismiss="modal">&times;</button>
               <h4 class="modal-title"><span class="glyphicon glyphicon-plus-sign"></span> &nbsp;Mostrar Informacion</h4>
            </div>
            <div class="modal-body">
              <embed src="@{{editArea.informacion_general}}" type="application/pdf" width="550" height="600"></embed>
            </div>
          </div>
        </div>
      </div>

      <!--Modal para mostrar el archivo IMG -->
      <div class="modal fade" id="myModalViewIMG" role="dialog">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
               <button type="button" class="close" data-dismiss="modal">&times;</button>
               <h4 class="modal-title"><span class="glyphicon glyphicon-plus-sign"></span> &nbsp;Mostrar Imagen</h4>
            </div>
            <div class="modal-body">
              <img src="@{{editArea.imagen_general}}" width="550" height="600">
            </div>
          </div>
        </div>
      </div>

      <!--Modal para mostrar el archivo MP4 -->
      <div class="modal fade" id="myModalViewVid" role="dialog">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
               <button type="button" class="close" data-dismiss="modal">&times;</button>
               <h4 class="modal-title"><span class="glyphicon glyphicon-plus-sign"></span> &nbsp;Mostrar Video</h4>
            </div>
            <div class="modal-body">
              <video src="@{{editArea.video_general}}" controls=true width="550" height="600">
		        ...
		        <div class="modal-body">
			        <form class="form-horizontal" enctype="multipart/form-data">
					    ...
					    <div class="form-group">
					      ...
					      <div class="col-sm-10">
					        <input type="file" class="form-control" id="imagen_general" name="imagen_general" file-model = "newArea.imagen_general" autofocus value="@{{newArea.imagen_general}}">@{{newArea.imagen_general}}
					      </div>
					    </div>

		...
		<table class="table table-striped" >
		    ...
		    <tbody>
		      ...
		      <tr ng-repeat="contenido in contenidos | filter:search:startsWith">
		        ...
		        <td><a href="" class="btn btn-default"><span class="fa fa-briefcase"></span></a>
            <a href="@{{contenido.informacion}}" class="btn btn-default"><span class="fa fa-file-pdf-o"></span></a> &nbsp;<a href="@{{contenido.video}}" class="btn btn-default"><span class="fa fa-film"></span></a> &nbsp;</td>

	  ...
	  <div class="container-fluid" style="background-color: #668933;">
		  <div class="container">
		      <div class="col-md-12">
		        <div class="col-md-3">
		      	  <h4 style="color: #fff;">QuetzalEdu</h4>
		      	  <h6><a href="#cursos" style="color: #fff;">Cursos</a></h6>
	              <h6><a href="#quienes-somos" style="color: #fff;">¿Quiénes somos?</a></h6>
	              <h6><a href="#experiencias" style="color: #fff;">Experiencias</a></h6>
	              <h6><a href="#contacto" style="color: #fff;">Contácto</a></h6>
		        </div>
		        <div class="col-md-3">
		        ...
		        <div class="col-md-3">
	              ...
	              <a href=""><h6 style="color: #fff;">Políticas de Uso</h6></a>
	              <a href=""><h6 style="color: #fff;">Términos y Condiciones</h6></a>
	              <a href=""><h6 style="color: #fff;">¡Ayúdanos a mejorar!</h6></a>
	 			  <a href=""><h6 style="color: #fff;">Agradecimientos</h6></a>
		        </div>
		        <div class="col-md-3">

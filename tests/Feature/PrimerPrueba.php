...
class PrimerPrueba extends TestCase
{
    /**
...
public function testWelcome()
    {
        ...
        $response2 = $this->get('/nuestras-apps');
        $response2->assertStatus(200);

        $response3 = $this->get('/modelo-educativo');
    ...
    function testUserAuthLogin(){
        ...
        $user = factory(User::class)->create([
            ...
            'password' => bcrypt($password = 'edunovac1808@'),
    ...
    function testUserErrorEnAuth(){
        ...
        $user = factory(User::class)->create([
            'password' => bcrypt('edunovac1808@'),
            'tipo' => '3',
        ]);
        
        $response = $this->from('/login')->post('/login', [
            'email' => $user->email,
            'password' => 'edunovac1807',
        ]);
